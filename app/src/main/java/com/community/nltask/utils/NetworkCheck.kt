package com.community.nltask.utils
...
import com.community.nltask.R

class NetworkCheck    // TODO Auto-generated constructor stub
    (var context: Context) {
    companion object {
        ...
        fun showNetworkFailureAlert(context: Context?) {
            if (context != null && !(context as Activity).isFinishing && (alert == null || alert != null) && !alert!!.isShowing) {
                ...
                nbutton.setTextColor(context.getResources().getColor(R.color.purple_500))
            }
        }
    }
}